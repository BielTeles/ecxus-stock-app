...
import { X, Building2, User, Mail, Phone, MapPin, Globe, DollarSign, Calendar, AlertCircle } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setErrors({ general: 'Erro inesperado ao adicionar fornecedor' })
      }
    } finally {
